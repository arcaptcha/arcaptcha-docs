...
### <bdi dir="ltr">arcaptcha.render(container, params)</bdi>
...
### <bdi dir="ltr">arcaptcha.reset(widgetID)</bdi>
...
### <bdi dir="ltr">arcaptcha.getArcToken(widgetID)</bdi>
...
### <bdi dir="ltr">arcaptcha.execute(widgetID)</bdi>
